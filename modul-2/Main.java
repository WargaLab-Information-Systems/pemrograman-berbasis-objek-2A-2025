...
public class Main {
    public static void main(String[] args) {
        ...
        Mahasiswa m1 = new Mahasiswa("caca", "2317788943", "Sistem Informasi");
        Mahasiswa m2 = new Mahasiswa("Nia", "2316578654", "Teknik Informatika");
        Mahasiswa m3 = new Mahasiswa("Nana", "2312345680", "Teknik Informasi");
        Mahasiswa m4 = new Mahasiswa("Joko", "2312345689", "Sistem Informasi");
        Mahasiswa m5 = new Mahasiswa("Mamat", "2312345682", "Teknik Informatika");
        Mahasiswa m6 = new Mahasiswa("Herry", "2312345683", "Teknik Informatika");
